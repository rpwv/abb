...
`.trim()
    conn.sendButton(m.chat, str, botdate, pp, [[`${registered ? 'Menu Bot':'Verikasi'}`, `${user.registered ? '.menu':'.verify'}`]], fkon, { contextInfo: { mentionedJid: [who], forwardingScore: 999, isForwarded: true}})
}
